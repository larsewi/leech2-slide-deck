...
\begin{tikzpicture}[
  ...
  \node[block] (a) {f753496...};
  \node[block, right=5mm of a] (b) {c4b22f2...};
  \node[block, right=5mm of b] (c) {3294a7e...};
  \draw[arr] (b) -- (a);
  \draw[arr] (c) -- (b);
...
Rule & Parent & Child & Result \\
\hline
6a & \texttt{insert} & \texttt{delete} &                \\
6b & \texttt{insert} & \texttt{delete} & \texttt{error} \\
\end{tabular}
\end{table}
\begin{example}
...
Rule & Parent & Child & Result \\
\hline
7a & \texttt{insert} & \texttt{update} & \texttt{insert} \\
7b & \texttt{insert} & \texttt{update} & \texttt{error}  \\
\end{tabular}
\end{table}
\begin{example}
...
Rule & Parent & Child & Result \\
\hline
9a & \texttt{delete} & \texttt{insert} &                 \\
9b & \texttt{delete} & \texttt{insert} & \texttt{update} \\
\end{tabular}
\end{table}
\begin{example}
...
Rule & Parent & Child & Result \\
\hline
14a & \texttt{update} & \texttt{delete} & \texttt{delete} \\
14b & \texttt{update} & \texttt{delete} & \texttt{error}  \\
\end{tabular}
\end{table}
\begin{example}
...
Rule & Parent & Child & Result \\
\hline
15a & \texttt{update} & \texttt{update} & \texttt{update} \\
15b & \texttt{update} & \texttt{update} &                 \\
15c & \texttt{update} & \texttt{update} & \texttt{error}  \\
\end{tabular}
\end{table}
\begin{example}
